...
const BASEBALL_Q = {
  0: {
    100: [
      ...
      { clue: "These 'Amazin'' underdogs shocked the baseball world by winning the 1969 World Series.", answer: "New York Mets", accept: ["new york mets", "mets", "ny mets"], choices: ["Chicago Cubs", "Baltimore Orioles", "Cincinnati Reds"], diff: 3 },
    ...
    200: [
      { clue: "The 2004 World Series champions who overcame an 0-3 ALCS deficit to end their famous 86-year championship drought.", answer: "Boston Red Sox", accept: ["boston red sox", "red sox"], choices: ["New York Yankees", "St. Louis Cardinals", "Chicago Cubs"], diff: 3 },
    ...
    300: [
      { clue: "Kirk Gibson hit his iconic pinch-hit walk-off home run in Game 1 of the World Series for this 1988 champion.", answer: "Los Angeles Dodgers", accept: ["los angeles dodgers", "dodgers", "la dodgers"], choices: ["Oakland Athletics", "New York Mets", "Boston Red Sox"], diff: 3 },
      { clue: "This franchise won three consecutive World Series championships from 1972 to 1974.", answer: "Oakland Athletics", accept: ["oakland athletics", "oakland a's", "a's", "athletics"], choices: ["New York Yankees", "Cincinnati Reds", "Baltimore Orioles"], diff: 4 },
    ...
    400: [
      { clue: "This Pittsburgh Pirates second baseman hit a walk-off home run in the bottom of the 9th of Game 7 to win the 1960 World Series.", answer: "Bill Mazeroski", accept: ["bill mazeroski", "mazeroski"], choices: ["Roberto Clemente", "Dick Groat", "Roy Face"], diff: 4 },
      { clue: "Injured and barely able to walk, this Dodger hit a pinch-hit two-run walk-off homer in Game 1 of the 1988 World Series.", answer: "Kirk Gibson", accept: ["kirk gibson", "gibson"], choices: ["Steve Sax", "Mike Scioscia", "Mickey Hatcher"], diff: 3 },
      { clue: "This Red Sox catcher waved his iconic home run fair with his arm in Game 6 of the 1975 World Series.", answer: "Carlton Fisk", accept: ["carlton fisk", "fisk"], choices: ["Johnny Bench", "Thurman Munson", "Ted Simmons"], diff: 4 },
  ...
  1: {
    100: [
      ...
      { clue: "Known as 'The Hammer,' this player held the all-time home run record for decades before it was broken.", answer: "Hank Aaron", accept: ["hank aaron", "aaron", "hammerin hank"], choices: ["Babe Ruth", "Barry Bonds", "Willie Mays"], diff: 3 },
    ...
    200: [
      { clue: "Babe Ruth set the single-season home run record in 1927 by hitting this many home runs.", answer: "60", accept: ["60", "sixty"], choices: ["61", "59", "58"], diff: 4 },
      { clue: "Hank Aaron hit his record-breaking 715th home run in 1974 while playing for this team.", answer: "Atlanta Braves", accept: ["atlanta braves", "braves"], choices: ["Milwaukee Brewers", "Cincinnati Reds", "Los Angeles Dodgers"], diff: 3 },
    ...
    300: [
      { clue: "Mickey Mantle won the Triple Crown in 1956, leading the AL in batting average, home runs, and this third statistical category.", answer: "RBI", accept: ["rbi", "rbis", "runs batted in"], choices: ["Stolen Bases", "On-Base Percentage", "Slugging Percentage"], diff: 4 },
    ...
    400: [
      { clue: "Barry Bonds set the single-season home run record in 2001 with this many home runs.", answer: "73", accept: ["73", "seventy-three", "seventy three"], choices: ["70", "72", "71"], diff: 4 },
      { clue: "Sammy Sosa hit 66 home runs in 1998 for the Cubs, finishing second to Mark McGwire. What was McGwire's total?", answer: "70", accept: ["70", "seventy"], choices: ["68", "72", "69"], diff: 4 },
  ...
  2: {
    100: [
      { clue: "This player broke the color barrier in Major League Baseball on April 15, 1947, wearing number 42.", answer: "Jackie Robinson", accept: ["jackie robinson", "robinson"], choices: ["Willie Mays", "Satchel Paige", "Larry Doby"], diff: 2 },
      { clue: "Joe DiMaggio began his legendary 56-game hitting streak on May 15 of this year.", answer: "1941", accept: ["1941"], choices: ["1939", "1942", "1940"], diff: 4 },
    ...
    200: [
      { clue: "Don Larsen threw the only perfect game in World Series history in 1956, playing for this team.", answer: "New York Yankees", accept: ["new york yankees", "yankees", "ny yankees"], choices: ["Brooklyn Dodgers", "Milwaukee Braves", "Chicago White Sox"], diff: 3 },
      { clue: "Hank Aaron broke Babe Ruth's all-time home run record with his 715th homer in this year.", answer: "1974", accept: ["1974"], choices: ["1972", "1973", "1975"], diff: 4 },
      { clue: "Joe DiMaggio's 56-game hitting streak ended when it was stopped by pitchers from this team.", answer: "Cleveland Indians", accept: ["cleveland indians", "indians", "cleveland"], choices: ["Boston Red Sox", "Chicago White Sox", "St. Louis Browns"], diff: 4 },
    ...
    300: [
      { clue: "Known as the 'Friendly Confines,' Wrigley Field opened in this year.", answer: "1914", accept: ["1914"], choices: ["1912", "1916", "1920"], diff: 4 },
      { clue: "The first MLB All-Star Game was played in 1933 at this Chicago stadium.", answer: "Comiskey Park", accept: ["comiskey park", "comiskey"], choices: ["Wrigley Field", "Forbes Field", "Polo Grounds"], diff: 4 },
      { clue: "MLB banned this fielding strategy in 2023, requiring two infielders on each side of second base.", answer: "defensive shift", accept: ["defensive shift", "shift", "infield shift"], choices: ["four-man outfield", "intentional walk", "defensive positioning"], diff: 1 },
    ],
    400: [
      { clue: "The American League adopted the designated hitter rule in this year.", answer: "1973", accept: ["1973"], choices: ["1969", "1971", "1975"], diff: 4 },
      { clue: "The 1994 players' strike resulted in the cancellation of this event for the first time since 1904.", answer: "World Series", accept: ["world series"], choices: ["All-Star Game", "League Championship Series", "MLB Draft"], diff: 3 },
      { clue: "The Astrodome in Houston opened in 1965 and was nicknamed this for being an engineering marvel.", answer: "Eighth Wonder of the World", accept: ["eighth wonder of the world", "eighth wonder"], choices: ["House of Grass", "The Dome", "Space Stadium"], diff: 4 },
  ...
  3: {
    100: [
      { clue: "Pete Rose holds the all-time MLB hits record with this many career hits.", answer: "4,256", accept: ["4256", "4,256", "four thousand two hundred fifty-six"], choices: ["3,771", "3,630", "4,191"], diff: 4 },
      { clue: "This player holds the MLB all-time stolen base record with 1,406 career stolen bases.", answer: "Rickey Henderson", accept: ["rickey henderson", "henderson"], choices: ["Lou Brock", "Tim Raines", "Vince Coleman"], diff: 3 },
      { clue: "Aaron Judge set the American League single-season home run record in 2022, breaking Roger Maris's record of 61. How many did Judge hit?", answer: "62", accept: ["62", "sixty-two", "sixty two"], choices: ["63", "61", "65"], diff: 2 },
    ],
    200: [
      ...
      { clue: "Rickey Henderson set the single-season stolen base record in 1982 with how many steals?", answer: "130", accept: ["130", "one hundred thirty"], choices: ["118", "100", "143"], diff: 4 },
    ...
    300: [
      { clue: "Orel Hershiser set the record for consecutive scoreless innings pitched in 1988 with this many innings.", answer: "59", accept: ["59", "fifty-nine", "fifty nine"], choices: ["58", "60", "55"], diff: 4 },
      { clue: "Kerry Wood struck out this many batters in a single game in 1998, tying the NL record.", answer: "20", accept: ["20", "twenty"], choices: ["19", "18", "21"], diff: 4 },
      { clue: "The 2001 Seattle Mariners tied the 1906 Chicago Cubs record for most wins in a season with this many victories.", answer: "116", accept: ["116", "one hundred sixteen"], choices: ["114", "111", "118"], diff: 4 },
    ],
    400: [
      { clue: "Nolan Ryan holds the all-time MLB strikeout record. How many career strikeouts did he record?", answer: "5,714", accept: ["5714", "5,714", "five thousand seven hundred fourteen"], choices: ["4,875", "3,509", "4,136"], diff: 4 },
      ...
      { clue: "Ichiro Suzuki set the single-season hits record in 2004 with how many hits?", answer: "262", accept: ["262", "two hundred sixty-two", "two hundred sixty two"], choices: ["257", "248", "271"], diff: 4 },
  ...
  4: {
    100: [
      ...
      { clue: "When a fielder mishandles or drops a ball, allowing a batter or runner to advance, it is scored as this.", answer: "error", accept: ["error", "e"], choices: ["passed ball", "wild pitch", "fielder's choice"], diff: 1 },
    ...
    200: [
      ...
      { clue: "Since 2023, MLB places a runner on second base at the start of extra innings. This runner is known by this nickname.", answer: "ghost runner", accept: ["ghost runner", "free runner", "automatic runner"], choices: ["bonus runner", "extra runner", "pace runner"], diff: 1 },
    ],
    300: [
      ...
      { clue: "This team popularized the 'opener' strategy, using a reliever to start the game before a bulk pitcher takes over.", answer: "Tampa Bay Rays", accept: ["tampa bay rays", "rays", "tampa bay"], choices: ["Oakland Athletics", "Houston Astros", "Chicago Cubs"], diff: 2 },
    ],
    400: [
  ...
  5: {
    100: [
      { clue: "Hall of Famer Willie Mays was nicknamed this, reflecting his enthusiastic greeting to teammates.", answer: "Say Hey Kid", accept: ["say hey kid", "the say hey kid"], choices: ["The Hammer", "The Natural", "Big Willie"], diff: 2 },
      { clue: "Joe DiMaggio earned the nickname 'Yankee Clipper' and set his famous 56-game hitting streak in this year.", answer: "1941", accept: ["1941"], choices: ["1939", "1942", "1937"], diff: 4 },
      { clue: "Randy Johnson, known as 'The Big Unit,' stood this tall and won 5 Cy Young Awards.", answer: "6 feet 10 inches", accept: ["6'10\"", "6 feet 10 inches", "6-10", "six foot ten", "six feet ten inches"], choices: ["6'7\"", "6'8\"", "7'0\""], diff: 4 },
    ...
    200: [
      ...
      { clue: "Reggie Jackson earned the nickname 'Mr. October' by hitting three home runs on three consecutive pitches in Game 6 of the 1977 World Series for this team.", answer: "New York Yankees", accept: ["new york yankees", "yankees", "ny yankees"], choices: ["Oakland Athletics", "California Angels", "Baltimore Orioles"], diff: 3 },
      { clue: "Nolan Ryan, known as 'The Ryan Express,' pitched in the majors until he was this age, a record for a starting pitcher.", answer: "46", accept: ["46", "forty-six", "forty six"], choices: ["44", "45", "47"], diff: 4 },
    ...
    300: [
      { clue: "Ted Williams, known as 'The Splendid Splinter,' was the last MLB player to hit over .400 in a season, hitting .406 in this year.", answer: "1941", accept: ["1941"], choices: ["1939", "1940", "1942"], diff: 4 },
      ...
      { clue: "Ichiro Suzuki made history in 2001 by winning both the AL MVP and this other award in the same season.", answer: "Rookie of the Year", accept: ["rookie of the year", "al rookie of the year", "american league rookie of the year"], choices: ["Gold Glove", "Silver Slugger", "Batting Title"], diff: 3 },
    ],
    400: [
      { clue: "Known as the 'Georgia Peach,' this player holds the MLB all-time career batting average record at .366.", answer: "Ty Cobb", accept: ["ty cobb", "cobb"], choices: ["Rogers Hornsby", "Ted Williams", "Joe Jackson"], diff: 4 },
      { clue: "Sandy Koufax won three Cy Young Awards and abruptly retired at just 30 years old due to this medical condition.", answer: "arthritis", accept: ["arthritis", "elbow arthritis", "traumatic arthritis"], choices: ["torn rotator cuff", "bone spurs", "elbow ligament damage"], diff: 3 },
      { clue: "Roberto Clemente became the first Latin American player inducted into the Baseball Hall of Fame in 1973. He died in a plane crash while delivering aid to this country.", answer: "Nicaragua", accept: ["nicaragua"], choices: ["Puerto Rico", "Dominican Republic", "Panama"], diff: 4 },
      { clue: "Mike Piazza holds the record for most career home runs by a catcher with 427. For which team did he spend most of his career?", answer: "New York Mets", accept: ["new york mets", "mets", "ny mets"], choices: ["Los Angeles Dodgers", "San Diego Padres", "Florida Marlins"], diff: 3 },
    ],
  },
};
...
const BASEBALL_EXTRA = {
  ...
  0: {
    100: [
      ...
      { clue: "The 1969 'Miracle Mets' defeated the Baltimore Orioles in the World Series, managed by this Hall of Famer.", answer: "Gil Hodges", accept: ["gil hodges", "hodges"], choices: ["Casey Stengel", "Yogi Berra", "Leo Durocher"], diff: 4 },
      { clue: "In the 2004 ALCS, the Boston Red Sox became the first team in MLB history to overcome a 3-0 series deficit to beat this opponent.", answer: "New York Yankees", accept: ["new york yankees", "yankees", "the yankees"], choices: ["Oakland Athletics", "Minnesota Twins", "Cleveland Indians"], diff: 3 },
      { clue: "The St. Louis Cardinals won their most recent World Series title in this year, defeating the Texas Rangers in Game 7.", answer: "2011", accept: ["2011"], choices: ["2006", "2004", "2013"], diff: 3 },
      { clue: "The 1994 World Series was never played because of this event that cancelled the postseason.", answer: "Players Strike", accept: ["players strike", "strike", "labor strike", "mlb strike"], choices: ["Hurricane", "Earthquake", "Commissioner's Death", "Lockout"], diff: 3 },
      { clue: "The 2004 Red Sox ALCS comeback MVP was this 'Big Papi' designated hitter.", answer: "David Ortiz", accept: ["david ortiz", "ortiz", "big papi"], choices: ["Manny Ramirez", "Kevin Millar", "Jason Varitek"], diff: 3 },
    ],
    200: [
      { clue: "The Cardinals' Bob Gibson dominated the 1967 World Series, winning this many games against the Boston Red Sox.", answer: "Three", accept: ["three", "3"], choices: ["Two", "Four", "One"], diff: 4 },
      { clue: "Montreal had the best record in baseball (74-40) when the 1994 strike hit. This was the only year this franchise had a realistic chance at a title before eventually relocating.", answer: "Montreal Expos", accept: ["montreal expos", "expos", "the expos"], choices: ["Pittsburgh Pirates", "San Diego Padres", "Cincinnati Reds"], diff: 3 },
      { clue: "Fernando Valenzuela led the Dodgers to win this championship in his legendary 1981 rookie season.", answer: "World Series", accept: ["world series", "the world series", "1981 world series"], choices: ["NLCS", "NL West Division", "Pennant"], diff: 3 },
      { clue: "The Cardinals have won 11 World Series titles. This decade saw them win 3 championships: 1942, 1944, and 1946.", answer: "1940s", accept: ["1940s", "the 1940s", "forties"], choices: ["1930s", "1950s", "1920s"], diff: 4 },
    ],
    300: [
      { clue: "The 1982 St. Louis Cardinals defeated this team in the World Series, clinching in 7 games.", answer: "Milwaukee Brewers", accept: ["milwaukee brewers", "brewers", "the brewers"], choices: ["Kansas City Royals", "California Angels", "Baltimore Orioles"], diff: 4 },
      { clue: "The 2004 ALCS lasted this many games, with Boston winning the final four after dropping the first three.", answer: "Seven", accept: ["seven", "7"], choices: ["Five", "Six", "Four"], diff: 4 },
      { clue: "St. Louis won the World Series in 1964 over the Yankees in large part thanks to this pitcher who also won the 1964 NL MVP.", answer: "Bob Gibson", accept: ["bob gibson", "gibson"], choices: ["Lou Brock", "Curt Flood", "Tim McCarver"], diff: 4 },
      { clue: "The 1948 Cleveland Indians won the World Series, making Satchel Paige the first Black pitcher to win a World Series game. The Indians defeated this team in the Series.", answer: "Boston Braves", accept: ["boston braves", "braves"], choices: ["Brooklyn Dodgers", "New York Giants", "Philadelphia Phillies"], diff: 4 },
      { clue: "The Cardinals won the World Series in 1934 featuring this colorful outfielder who won the Triple Crown in the NL that year.", answer: "Joe Medwick", accept: ["joe medwick", "medwick", "ducky medwick"], choices: ["Dizzy Dean", "Pepper Martin", "Frankie Frisch"], diff: 4 },
    ],
    400: [
      { clue: "In 1926, Rogers Hornsby managed and played for the Cardinals to win their first World Series title, defeating these Yankees in 7 games.", answer: "New York Yankees", accept: ["new york yankees", "yankees"], choices: ["Philadelphia Athletics", "Washington Senators", "Chicago White Sox"], diff: 4 },
      ...
      { clue: "The Cardinals' 1944 'Streetcar Series' opponent was the only other team from the same city to ever appear in a World Series against them. This team was the:", answer: "St. Louis Browns", accept: ["st. louis browns", "browns", "st louis browns"], choices: ["Chicago Cubs", "Cincinnati Reds", "Pittsburgh Pirates"], diff: 4 },
  ...
  1: {
    100: [
      { clue: "Mark McGwire hit 70 home runs in 1998, breaking the single-season record previously held by this New York Yankee.", answer: "Roger Maris", accept: ["roger maris", "maris"], choices: ["Babe Ruth", "Mickey Mantle", "Joe DiMaggio"], diff: 3 },
      { clue: "In 1998, Sammy Sosa hit this many home runs to finish second behind Mark McGwire in the famous home run race.", answer: "66", accept: ["66", "sixty-six", "sixty six"], choices: ["63", "61", "65"], diff: 4 },
      { clue: "Mickey Mantle hit 536 career home runs and is considered the greatest player ever at this position.", answer: "Center Field", accept: ["center field", "centerfield", "cf"], choices: ["First Base", "Left Field", "Right Field"], diff: 3 },
      { clue: "Frank Robinson won the AL Triple Crown in 1966 with 49 home runs for this team.", answer: "Baltimore Orioles", accept: ["baltimore orioles", "orioles", "the orioles"], choices: ["Cincinnati Reds", "New York Yankees", "Minnesota Twins"], diff: 4 },
    ...
    200: [
      { clue: "Mickey Mantle was the only switch-hitter to ever win baseball's Triple Crown, achieving the feat in this year.", answer: "1956", accept: ["1956"], choices: ["1955", "1957", "1961"], diff: 4 },
      { clue: "Frank Robinson became the first player to win MVP awards in both leagues. He won the NL MVP with this team before the Orioles.", answer: "Cincinnati Reds", accept: ["cincinnati reds", "reds", "the reds"], choices: ["Pittsburgh Pirates", "Milwaukee Braves", "San Francisco Giants"], diff: 4 },
      { clue: "Bryce Harper won his second NL MVP award in 2021 with a .309 average, 35 home runs, and a league-leading 42 of these extra-base hits.", answer: "Doubles", accept: ["doubles", "double"], choices: ["Triples", "Home runs", "Stolen Bases"], diff: 2 },
      { clue: "Mark McGwire broke Roger Maris's record with his 62nd home run on September 8, 1998, ironically against this team that also featured Sammy Sosa.", answer: "Chicago Cubs", accept: ["chicago cubs", "cubs", "the cubs"], choices: ["Houston Astros", "Pittsburgh Pirates", "Cincinnati Reds"], diff: 4 },
    ...
    300: [
      { clue: "In 2022 he became just the fourth player in MLB history to reach 700 career home runs, joining Babe Ruth, Hank Aaron, and Barry Bonds.", answer: "Albert Pujols", accept: ["albert pujols", "pujols"], choices: ["Alex Rodriguez", "Ken Griffey Jr.", "Sammy Sosa"], diff: 2 },
      ...
      { clue: "Sammy Sosa hit 60 or more home runs in THREE different seasons. The years were 1998, 1999, and this year.", answer: "2001", accept: ["2001"], choices: ["2000", "2002", "2003"], diff: 4 },
    ...
    400: [
      ...
      { clue: "Josh Gibson is credited with hitting close to 800 career home runs, though his Baseball Hall of Fame plaque says 'almost' this many.", answer: "800", accept: ["800", "eight hundred"], choices: ["700", "900", "600"], diff: 4 },
  ...
  2: {
    100: [
      { clue: "Fernando Valenzuela became the first, and still only, player to win both the Cy Young Award and Rookie of the Year in the same season, doing so in this year.", answer: "1981", accept: ["1981"], choices: ["1979", "1983", "1977"], diff: 3 },
      { clue: "Roberto Clemente became the first Latin American player elected to the Baseball Hall of Fame. He was inducted in this year, the year after his death.", answer: "1973", accept: ["1973"], choices: ["1972", "1975", "1971"], diff: 4 },
      { clue: "Satchel Paige made his MLB debut with the Cleveland Indians in 1948 at age 42, making him the oldest player ever to debut in the major leagues.", answer: "42", accept: ["42", "forty-two", "forty two"], choices: ["38", "44", "40"], diff: 3 },
      { clue: "Ron Blomberg of the New York Yankees became the first designated hitter in MLB history on Opening Day of this year.", answer: "1973", accept: ["1973"], choices: ["1972", "1974", "1975"], diff: 4 },
    ...
    200: [
      { clue: "Roberto Clemente recorded his 3,000th career hit in his final regular-season at-bat on September 30 of this year.", answer: "1972", accept: ["1972"], choices: ["1971", "1973", "1970"], diff: 4 },
      { clue: "Satchel Paige was also the first Black pitcher in the American League. He became the first Negro League inductee into the Baseball Hall of Fame in this year.", answer: "1971", accept: ["1971"], choices: ["1969", "1975", "1973"], diff: 4 },
      { clue: "The American League adopted the designated hitter rule on January 11, 1973. The rule was originally approved as a this-year experiment.", answer: "Three-year", accept: ["three-year", "three year", "3-year", "3 year", "three years"], choices: ["Two-year", "Five-year", "One-year"], diff: 4 },
    ...
    300: [
      { clue: "Tom Seaver set the all-time record for consecutive seasons with 200 or more strikeouts, accomplishing this nine times in a row from 1968 through this year.", answer: "1976", accept: ["1976"], choices: ["1975", "1977", "1978"], diff: 4 },
      { clue: "Roberto Clemente was the first Latin American player to record 3,000 career hits. His 3,000th hit was this type of hit.", answer: "Double", accept: ["double", "a double"], choices: ["Single", "Home Run", "Triple"], diff: 4 },
      ...
      { clue: "Pedro Martinez posted the highest single-season adjusted ERA+ in MLB history in this year.", answer: "2000", accept: ["2000"], choices: ["1999", "2001", "1998"], diff: 4 },
      { clue: "Frank Robinson became the first player to win MVP awards in both leagues when he won the 1966 AL MVP after previously winning the NL MVP with the Reds in this year.", answer: "1961", accept: ["1961"], choices: ["1962", "1959", "1963"], diff: 4 },
    ],
    400: [
      { clue: "Bob Gibson's 1.12 ERA in 1968 is the lowest in the 'Live Ball Era.' This indirectly led to MLB lowering the pitching mound from 15 inches to this height in 1969.", answer: "10 inches", accept: ["10 inches", "ten inches", "10\""], choices: ["8 inches", "12 inches", "6 inches"], diff: 4 },
      ...
      { clue: "Satchel Paige's MLB debut year of 1948 also ended with the Cleveland Indians winning the World Series — a championship that would not be repeated by that franchise until this year (2016 or never again under Cleveland name).", answer: "Never", accept: ["never", "they haven't", "not yet", "2016 as Indians"], choices: ["1954", "1997", "1987"], diff: 4 },
      { clue: "Roberto Clemente's plane crashed into the Atlantic Ocean on New Year's Eve 1972 while carrying relief supplies to this country devastated by a December earthquake.", answer: "Nicaragua", accept: ["nicaragua"], choices: ["Haiti", "Dominican Republic", "Puerto Rico"], diff: 4 },
  ...
  3: {
    100: [
      { clue: "Bob Gibson posted a 1.12 ERA in 1968 — the lowest in the modern era. He also went 22-9 with this many strikeouts that season.", answer: "268", accept: ["268", "two hundred sixty-eight"], choices: ["247", "285", "301"], diff: 4 },
      { clue: "Pedro Martinez posted a 1.74 ERA in 2000 — the lowest American League ERA since 1978. His ERA+ of 291 is the highest this stat has ever been in MLB history.", answer: "291", accept: ["291", "two hundred ninety-one"], choices: ["267", "310", "248"], diff: 4 },
      { clue: "Greg Maddux won 4 consecutive Cy Young Awards from 1992-1995. His ERA across those four seasons was below this number.", answer: "2.00", accept: ["2.00", "two", "under two", "below 2.00", "1.98"], choices: ["2.50", "2.25", "1.75"], diff: 4 },
      { clue: "Miguel Cabrera won the first Triple Crown in 45 years in 2012, batting .330 with 44 home runs and this many RBIs.", answer: "139", accept: ["139", "one hundred thirty-nine"], choices: ["121", "147", "132"], diff: 2 },
      { clue: "Derek Jeter retired with 3,465 career hits, the most ever by a player at this position.", answer: "Shortstop", accept: ["shortstop", "ss"], choices: ["Third Base", "Second Base", "Left Field"], diff: 3 },
    ],
    200: [
      { clue: "Tony Gwynn batted .394 in the strike-shortened 1994 season. In the month of August before the strike ended things, he batted this astronomical average.", answer: ".475", accept: [".475", "0.475", "point four seven five"], choices: [".423", ".450", ".389"], diff: 4 },
      ...
      { clue: "Tom Seaver finished his career with 311 wins and 3,640 strikeouts. He holds the Mets' all-time record in wins and is nicknamed this.", answer: "Tom Terrific", accept: ["tom terrific", "terrific"], choices: ["The Franchise", "Big Tom", "The Stork"], diff: 4 },
      { clue: "Wade Boggs won 5 batting titles with the Red Sox, all coming in a 6-year window from 1983 to 1988. He finished his 18-year career with exactly this many hits.", answer: "3,010", accept: ["3,010", "3010", "three thousand ten"], choices: ["2,987", "3,112", "3,056"], diff: 4 },
      { clue: "Yogi Berra won 10 World Series rings as a player — more than anyone in MLB history. He also holds the record for playing in this many World Series games.", answer: "75", accept: ["75", "seventy-five"], choices: ["63", "81", "68"], diff: 4 },
    ],
    300: [
      { clue: "Pedro Martinez won the 1999 pitching 'Triple Crown' — leading the AL in wins (23), ERA (2.07), and this counting stat (313).", answer: "Strikeouts", accept: ["strikeouts", "k's", "ks"], choices: ["Complete Games", "Shutouts", "Innings Pitched"], diff: 4 },
      { clue: "Bob Gibson pitched 28 complete games and this many shutouts in his dominant 1968 season.", answer: "13", accept: ["13", "thirteen"], choices: ["10", "16", "11"], diff: 4 },
      { clue: "Tony Gwynn won 8 batting titles in his career, all with the San Diego Padres. This placed him tied for the NL record with this Hall of Famer.", answer: "Honus Wagner", accept: ["honus wagner", "wagner", "the flying dutchman"], choices: ["Stan Musial", "Rogers Hornsby", "Willie Mays"], diff: 4 },
      { clue: "Roger Clemens was 42 years old when he won his 7th and final Cy Young Award in 2004. He won it pitching for this team.", answer: "Houston Astros", accept: ["houston astros", "astros", "the astros"], choices: ["New York Yankees", "Boston Red Sox", "Toronto Blue Jays"], diff: 4 },
    ],
    400: [
      ...
      { clue: "Greg Maddux's 4-year Cy Young run included his 1994 season where his ERA was a remarkable 1.56. His record that year was 16-6 for this team.", answer: "Atlanta Braves", accept: ["atlanta braves", "braves", "the braves"], choices: ["Chicago Cubs", "Los Angeles Dodgers", "San Diego Padres"], diff: 4 },
      ...
      { clue: "Johnny Bench won 10 consecutive Gold Gloves at catcher (1968-77). He was a two-time NL MVP, winning in 1970 and this other year.", answer: "1972", accept: ["1972"], choices: ["1971", "1973", "1975"], diff: 4 },
    ],
  },
  ...
  4: {
    100: [
      ...
      { clue: "Fernandomania was the pop-culture frenzy surrounding this Dodgers pitcher's spectacular 1981 rookie season.", answer: "Fernando Valenzuela", accept: ["fernando valenzuela", "valenzuela", "fernando"], choices: ["Tommy John", "Don Sutton", "Orel Hershiser"], diff: 3 },
    ],
    200: [
      { clue: "A pitcher's ERA+ of 291 — like Pedro Martinez achieved in 2000 — means the pitcher's ERA was this much better than league average.", answer: "191% better", accept: ["191% better", "191 percent better", "191 points above average", "nearly twice as good"], choices: ["291% better", "91% better", "2.91 times better"], diff: 4 },
      { clue: "In baseball lingo, 'The Wizard of Oz' was a nickname for this Cardinals shortstop known for his acrobatic defense.", answer: "Ozzie Smith", accept: ["ozzie smith", "smith", "the wizard"], choices: ["Cal Ripken Jr.", "Alan Trammell", "Barry Larkin"], diff: 3 },
      { clue: "The nickname 'Big Red Machine' referred to this dominant 1970s Ohio lineup featuring Pete Rose and Johnny Bench.", answer: "Cincinnati Reds", accept: ["cincinnati reds", "reds", "the reds", "big red machine"], choices: ["Oakland Athletics", "Baltimore Orioles", "Pittsburgh Pirates"], diff: 3 },
      ...
      { clue: "This colorful baseball phrase describes a home run that clears the fences with plenty of distance to spare — same as Mantle's famous 565-foot blast.", answer: "Tape measure home run", accept: ["tape measure home run", "tape measure shot", "tape measure homer"], choices: ["Moonshot", "Grand salami", "Walk-off"], diff: 4 },
    ],
    300: [
    ...
    400: [
      { clue: "The term 'WHIP' stands for Walks plus Hits per Inning Pitched. Pedro Martinez's 2000 WHIP of 0.737 is the second-lowest ever, meaning he gave up fewer than this fraction of a baserunner per inning.", answer: "One", accept: ["one", "1", "less than one"], choices: ["Two", "Three", "Half"], diff: 3 },
      { clue: "The 'dead ball era' roughly ended in 1920 after this change made offense explode across baseball.", answer: "Live ball introduced", accept: ["live ball introduced", "new ball introduced", "livelier baseball", "balls replaced more often", "livened ball"], choices: ["Expansion teams added", "Mound lowered", "DH rule added"], diff: 4 },
      ...
      { clue: "The 1994 players strike started on August 12 after players walked out over this core negotiating issue.", answer: "Salary cap", accept: ["salary cap", "the salary cap"], choices: ["Free agency", "Drug testing", "Revenue sharing"], diff: 4 },
      { clue: "Mickey Mantle's career on-base percentage of .421 is the record for this specific type of batter in MLB history.", answer: "Switch hitter", accept: ["switch hitter", "switch-hitter"], choices: ["Left-handed hitter", "Right-handed hitter", "Designated hitter"], diff: 4 },
    ],
  },
  ...
  5: {
    100: [
      { clue: "This Red Sox legend — the last man to bat .400 in a season — was famously cryogenically frozen after his 2002 death, with his head and body preserved separately.", answer: "Ted Williams", accept: ["ted williams", "williams"], choices: ["Babe Ruth", "Joe DiMaggio", "Mickey Mantle"], diff: 3 },
      { clue: "Derek Jeter received 396 of 397 possible Hall of Fame votes in 2020, the highest percentage ever by a player at his position. He was elected to the Hall alongside his Yankees teammate who received 100% of the vote.", answer: "Mariano Rivera", accept: ["mariano rivera", "rivera", "mo"], choices: ["Bernie Williams", "Jorge Posada", "Andy Pettitte"], diff: 2 },
      { clue: "Johnny Bench is widely considered the greatest catcher in baseball history. He spent his entire 17-year career with this franchise.", answer: "Cincinnati Reds", accept: ["cincinnati reds", "reds", "the reds"], choices: ["New York Yankees", "Los Angeles Dodgers", "Pittsburgh Pirates"], diff: 3 },
      { clue: "Tom Seaver won three Cy Young Awards and was known as 'The Franchise' for this team.", answer: "New York Mets", accept: ["new york mets", "mets", "the mets"], choices: ["Cincinnati Reds", "Boston Red Sox", "Chicago White Sox"], diff: 3 },
      { clue: "Roberto Clemente played his entire career with the Pittsburgh Pirates and won 12 Gold Gloves at this position.", answer: "Right Field", accept: ["right field", "rf"], choices: ["Left Field", "Center Field", "First Base"], diff: 3 },
      { clue: "Brooks Robinson won 16 consecutive Gold Gloves at third base, making him the all-time record holder at that position.", answer: "16", accept: ["16", "sixteen"], choices: ["13", "12", "18"], diff: 4 },
    ],
    200: [
      { clue: "Yogi Berra played his entire career with the Yankees and won 3 MVP awards. He also managed the Mets to the 1973 World Series, losing to this team.", answer: "Oakland Athletics", accept: ["oakland athletics", "athletics", "a's", "oakland a's"], choices: ["Cincinnati Reds", "Baltimore Orioles", "New York Yankees"], diff: 4 },
      { clue: "Wade Boggs famously won 5 batting titles with the Red Sox, but later won his only World Series ring with this team.", answer: "New York Yankees", accept: ["new york yankees", "yankees", "the yankees"], choices: ["Tampa Bay Devil Rays", "Cleveland Indians", "California Angels"], diff: 3 },
      ...
      { clue: "Fernando Valenzuela pitched his entire MLB career in the United States but was born and raised in this Mexican state.", answer: "Sonora", accept: ["sonora", "sonora mexico"], choices: ["Jalisco", "Sinaloa", "Chihuahua"], diff: 4 },
      { clue: "Satchel Paige also pitched for the Kansas City Athletics at age 59 in 1965. He threw this many scoreless innings in that appearance.", answer: "Three", accept: ["three", "3"], choices: ["Two", "One", "Six"], diff: 4 },
    ],
    300: [
      { clue: "Johnny Bench was a 10-time Gold Glove winner at catcher and is credited with revolutionizing how catchers hold their throwing hand, preventing this.", answer: "Foul tip injuries", accept: ["foul tip injuries", "foul tips", "finger injuries", "hand injuries"], choices: ["Stolen bases", "Wild pitches", "Passed balls"], diff: 4 },
      ...
      { clue: "Mike Trout won the AL Rookie of the Year unanimously in 2012 and followed it with 3 AL MVP awards. He spent his entire career with this franchise.", answer: "Los Angeles Angels", accept: ["los angeles angels", "angels", "anaheim angels", "la angels"], choices: ["Seattle Mariners", "Minnesota Twins", "Kansas City Royals"], diff: 2 },
      { clue: "Brooks Robinson's 1970 World Series performance earned him MVP honors. He batted .429 and made countless defensive gems in a series against this NL team.", answer: "Cincinnati Reds", accept: ["cincinnati reds", "reds", "the reds"], choices: ["Pittsburgh Pirates", "New York Mets", "San Francisco Giants"], diff: 4 },
...
const BASEBALL_EXTRA_20260622 = {
  "Ballparks": {
    questions: [
      { clue: "The original version of this Bronx stadium, opened in 1923, was nicknamed 'The House That Ruth Built' in honor of the slugger whose popularity funded it.", answer: "Yankee Stadium", accept: ["yankee stadium", "the house that ruth built", "old yankee stadium"], choices: ["Fenway Park", "Polo Grounds", "Ebbets Field"], diff: 3 },
      { clue: "Opened in 1962, this stadium is the third-oldest ballpark still in use in MLB, trailing only Fenway Park and Wrigley Field.", answer: "Dodger Stadium", accept: ["dodger stadium", "chavez ravine"], choices: ["Angel Stadium", "Oakland Coliseum", "Kauffman Stadium"], diff: 3 },
      ...
      { clue: "Opened in 1992, this Baltimore Orioles ballpark sparked the 'retro' stadium movement that swept through MLB in the following decades.", answer: "Oriole Park at Camden Yards", accept: ["oriole park at camden yards", "camden yards", "camden", "oriole park"], choices: ["Jacobs Field", "Coors Field", "PNC Park"], diff: 3 },
  ...
  "Perfect Games": {
    questions: [
      { clue: "Through the 2025 season, there have been exactly this many official perfect games thrown in modern MLB history.", answer: "24", accept: ["24", "twenty-four", "twenty four"], choices: ["18", "31", "27"], diff: 3 },
      { clue: "This New York Yankees pitcher threw MLB's most recent perfect game on June 28, 2023, against the Oakland Athletics.", answer: "Domingo German", accept: ["domingo german", "domingo germán", "german", "germán"], choices: ["Gerrit Cole", "Corey Kluber", "Nestor Cortes"], diff: 3 },
  ...
  "Players & History": {
    questions: [
      { clue: "The 'Curse of the Bambino' began when the Boston Red Sox sold Babe Ruth before the 1920 season to this team.", answer: "New York Yankees", accept: ["new york yankees", "yankees", "ny yankees"], choices: ["Chicago Cubs", "New York Giants", "Detroit Tigers"], diff: 3 },
  ...
  "Final Round": {
    questions: [
      ...
      { clue: "Name the Japanese-born starting pitcher who was named 2025 World Series MVP after recording three wins and a 1.02 ERA for the Dodgers.", answer: "Yoshinobu Yamamoto", accept: ["yoshinobu yamamoto", "yamamoto"], diff: 2 },
    ]
  }
};
...
const BASEBALL_EXTRA_20260629 = {
  "Speed & Stolen Bases": {
    questions: [
      { clue: "This Cardinals outfielder set the career stolen base record of 938, a mark that stood until Rickey Henderson broke it in 1991.", answer: "Lou Brock", accept: ["lou brock", "brock"], choices: ["Maury Wills", "Tim Raines", "Vince Coleman"], diff: 3 },
  ...
  "Awards & Honors": {
    questions: [
      { clue: "Don Newcombe won the very first Cy Young Award in 1956. Until 1967, this many Cy Young Awards were handed out each season.", answer: "One", accept: ["one", "1", "just one", "a single one"], choices: ["Two", "Three", "Four"], diff: 4 },
      { clue: "No player has won more MVP awards than this slugger, who captured the honor a record seven times.", answer: "Barry Bonds", accept: ["barry bonds", "bonds"], choices: ["Babe Ruth", "Albert Pujols", "Mike Trout"], diff: 3 },
      { clue: "MLB's Rookie of the Year Award is officially named after this trailblazer who broke the sport's color barrier in 1947.", answer: "Jackie Robinson", accept: ["jackie robinson", "robinson"], choices: ["Hank Aaron", "Roberto Clemente", "Larry Doby"], diff: 2 },
  ...
  "International Baseball": {
    questions: [
      { clue: "Japan won the 2023 World Baseball Classic when Shohei Ohtani struck out this Angels teammate of his for the final out.", answer: "Mike Trout", accept: ["mike trout", "trout"], choices: ["Mookie Betts", "Paul Goldschmidt", "Nolan Arenado"], diff: 1 },
  ...
  "Franchise History": {
    questions: [
      { clue: "By reaching the postseason in this year, the Seattle Mariners finally ended MLB's longest active playoff drought, dating back to 2001.", answer: "2022", accept: ["2022"], choices: ["2019", "2021", "2023"], diff: 2 },
      { clue: "After 36 seasons as the Montreal Expos, this franchise relocated and was renamed beginning with the 2005 season.", answer: "Washington Nationals", accept: ["washington nationals", "nationals", "the nationals", "nats"], choices: ["Texas Rangers", "Tampa Bay Rays", "Miami Marlins"], diff: 3 },
